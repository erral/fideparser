...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="""Merge CSV files created with fideparser.
    ...
    parser.add_argument(
        "outfile", type=str, help="The name of the file that will save the merged data"
    )

    parser.add_argument(
        "infiles", type=str, nargs="+", help="CSV filenames to be merged"
    )

    arguments = parser.parse_args()
    merge(arguments.outfile, arguments.infiles)
    print(
        "%s file was generated, after merging %s"
